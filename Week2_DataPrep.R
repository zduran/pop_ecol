...
##Note- 'filter' selects rows; 'select' filters columns
...
#Rule of thumb- 0.5-0.6 (not always)
### end predictor check ----------------
...
write.csv( closeddf, paste( getwd(),"/simdata/closedf.csv", sep = "" ),  
           row.names = FALSE )

#save open dataframe in our data folder:
write.csv( opendf, paste( getwd(),"/simdata/opendf.csv", sep = "" ),  
           row.names = FALSE )
