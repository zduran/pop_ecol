...
datadir <- paste( getwd(), "/zdrn_pop_ecol/", sep = "" )
...
# 110      0        4     4.45       0.05
# 111      0        9     8.68       0.01
# In general, most values were similar, with the exception that "011" instances
# i.e., where occupancy was not observed in the first visit, but was in the 
# second and third. Likely overdispersion, but not lack of fit.
# 
...
# Answer:
# underdispersed (one case of moderate overdispersion)
#
...
# Answer:
# Our full model explains approximately 30% of the variation 
#
...
# leave out? Why? 
# Answer:
# Our plot showing the relationship between sagebrush and detection is not 
# very informative (CI are very large)
