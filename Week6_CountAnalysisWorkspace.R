...
# Answer: while sagebrush have a positive coefficient, it is small and overlaps
# 0, so sagebrush cover may not be informative for observation (in 2009). 
# Cheatgrass has a negative coefficient and does not overlap 0, therefore 
# observations are negatively effected by cheatgrass.
# For detection, all techs but tech 1 (intercept) did not have an impact on 
# observation, but tech 1 had a positive impact (maybe overcounting?). Time
# of day had a significant negative impact on observation (i.e., as time of day
# increased, observations decreased).
#
#What is the mean abundance from our model?
exp(coef(fm.closed[1]))
# mean abundance in 2009: sagebrush = 1.03, cheatgrass = 0.676
...
# Answer: yikes, c-hat of 44.24? Might need to clarify with Cruz if this was
# intentional or if we are really THAT overdispersed?
#
...
# Answer: the full model explains more of the variation than the null
#
...
# Am I missing something with these really high c-hat vals?
...
# Answer: Not sure- need to ask JC
#
...
# Answer: Zoe- revisit paper to answer this
#
...
# Answer: residuals somewhat follow the identity line for the observation; could
# not plot the site-sum residuals, error "need finite 'ylim' values"
# 
...
# Answer: as percent cheatgrass increases, relative (predicted) abundance
# decreases.
#
...
# this shows same as last week'd analysis- as time past 6:00am increases, the
# probability of occupancy decreases.
############################################################################
